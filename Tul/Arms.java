...
public class Arms implements ActionListener,MouseListener,FocusListener
{
	JFrame fr;
	...
	public void focusLost(FocusEvent evt1)
	{
		...
		if(evt1.getSource()==t3)
		{
			...
			{
				ml3.setText("please fill the User_id");
			}
		}
	}
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		PreparedStatement stmt=con.prepareStatement("delete * from user1 where u_id=? u_username=? and u_password=?");
