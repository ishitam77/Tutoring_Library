...
import java.awt.event.*;
 public class Alogin implements ActionListener,MouseListener,FocusListener
{
	JFrame fr;
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		String sql="select * from admin3 where a3_username='"+t1.getText()+"' and a3_password='"+t2.getPassword().toString()+"'";
